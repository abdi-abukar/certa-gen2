...
export const vendors = [
  { id: 'anthropic', name: 'Anthropic', purpose: 'Staff-requested structured newsletter drafts', lifecycle: 'foundation', healthEndpoint: '/api/vendors/anthropic/health', probe: 'GET public status API', scope: 'Provider-reported status only; does not verify model access or generation.', intervalSeconds: 60 },
