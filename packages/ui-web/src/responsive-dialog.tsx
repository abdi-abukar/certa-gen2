...
function DialogSurface({ title, description, children, artwork, artworkSide = 'right', layout = 'balanced', mobileArtwork = 'hidden', contentSized = false, onClose }: DialogProps) {
  const id = useId();
  ...
  return <dialog ref={dialog} className={styles.dialog} data-closing={closing} data-artwork={Boolean(artwork)} data-artwork-side={artworkSide} data-layout={layout} data-mobile-artwork={mobileArtwork} data-content-sized={contentSized}
      ...
      <div className={styles.surface}>
        ...
        <div ref={scrollArea} className={styles.scrollArea}>
          <div className={styles.layout}>
            {artwork && artworkSide === 'left' && <aside className={styles.artwork}>{artwork}</aside>}
            ...
            {artwork && artworkSide === 'right' && <aside className={styles.artwork}>{artwork}</aside>}
          </div>
        </div>
      </div>
    </div>
