...
export default {
  ...
  images: { maximumRedirects: 0, remotePatterns: (process.env.CERTA_SUPABASE_URL || process.env.SUPABASE_URL) ? [new URL('/storage/v1/object/public/certa-content/**', process.env.CERTA_SUPABASE_URL || process.env.SUPABASE_URL)] : [] },
