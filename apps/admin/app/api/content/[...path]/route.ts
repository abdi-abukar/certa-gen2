...
async function handle(request:Request,context:{params:Promise<{path:string[]}>}){return contentResponse(request,(await context.params).path,true,renderNewsletter);}
